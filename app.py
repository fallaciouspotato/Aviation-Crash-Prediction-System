...
# --- Crash Case Studies Page ---
    ...
    with st.expander("🇯🇵 Japan Airlines Flight 123 (1985)"):
        st.markdown("A faulty repair led to an explosive decompression which destroyed all hydraulic controls, leading to the deadliest single-aircraft accident in history.")
